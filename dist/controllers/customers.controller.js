...
async function createCustomerController(req, res) {
    try {
        ...
        const companyId = req.user.company;
        await (0, customers_service_1.createCustomerService)(name, address, companyId);
        return res.json({
...
async function updateCustomerController(req, res) {
    try {
        ...
        const companyId = req.user.company;
        const { name, address } = req.body;
        await (0, customers_service_1.updateCustomerService)(name, address, customerId, companyId);
        return res.json({
